...
<html id = "grappleActionBackgroundArea">
	...
	<body>
		<form action = "_module.grapple.url.action.completion.php" method = "post" enctype="multipart/form-data" >
			<table>
				<tbody>
					</tr>	
					...
					<?php
						foreach ( $_SESSION [ 'databaseRecordCollection' ] as $nameCollectionItem ) 
						{
							//echo $nameCollectionItem;
						}
					?>
