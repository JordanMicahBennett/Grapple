...
function generateGrappleActionResponse ( data, dataSource, grappleActionType )
{
	...
	window.open("http://localhost/grapple/data/modules/php/_module.grapple."+grappleActionType+".action.php?grappleContent="+browserGrappleActionContentStream+"&grappleSource="+browserGrappleActionContentSource+"&grappleType="+grappleActionType,"popup","width=512,height=614");
}
